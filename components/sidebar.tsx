...
export default function Sidebar () {
    ...
    <div className={"flex justify-between flex-col bg-gray-900 py-8 px-8 h-screen"}>
        <div className={"flex flex-col space-y-6 "}>
            ...
            <div className={"flex items-center space-x-2 hover:bg-gray-600 rounded-md px-4 py-2 cursor-pointer text-gray-400 hover:text-gray-50 transform duration-150"}>
        ...
        <Link href={"/"} className={"flex items-center space-x-2 hover:bg-gray-600 rounded-md px-4 py-2 cursor-pointer text-gray-400 hover:text-gray-50 transform duration-150"}>
