    ...
    <header className='flex space-x-3 items-center mt-5 justify-between px-5'>
      ...
      {user.name ? (
        <ul className="flex space-x-3 mr-2 items-center">
          <li onClick={() => setShowModalSignIn(true)} className="cursor-pointer px-3 py-2 bg-purple-300 rounded-xl hover:bg-purple-500 active:bg-purple-200 transition duration-100">Profile</li>
          <li onClick={() => setShowModalSignUp(true)} className="cursor-pointer px-3 py-2 bg-gray-100 rounded-xl hover:bg-gray-200 transition duration-100">Log out</li>
        </ul>
      ): (
        <ul className="flex space-x-3 mr-2 items-center">
